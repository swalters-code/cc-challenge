...
---@alias peripheralNames peripheralName[]
---@alias wrappedPeripherals wrappedInventoryPeripheral[]

local threadcount = 0

-- Get all details for all slots in the peripherals.  Returns a
-- table mapping peripheral names to tables mapping slot numbers to
-- item detail tables.
---@param peripherals wrappedPeripherals
---@param names peripheralNames
